...
DROP POLICY IF EXISTS "Admins can delete components" ON public.components;
...
DROP TRIGGER IF EXISTS update_component_after_transaction ON public.transactions;
